...
public extension Keychain.InternetPassword {
    /// Deletes an internet password using an item reference.
    ///
    ...
    /// Synchronously deletes an internet password using an item reference.
    ///
    /// This is the synchronous variant of ``delete(itemReference:authenticationContext:)-15n8h`` and can be safely
