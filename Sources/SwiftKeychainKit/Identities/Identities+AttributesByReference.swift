...
public extension Keychain.Identities {
    /// Gets the attributes of an identity using an item reference.
    ///
    /// Retrieves the metadata for the identity identified by the given ``ItemReference``. The reference uniquely
