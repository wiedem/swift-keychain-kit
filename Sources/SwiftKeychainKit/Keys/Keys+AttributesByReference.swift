...
public extension Keychain.Keys {
    /// Gets the attributes of a key using an item reference.
    ///
    /// Retrieves the metadata for the key identified by the given ``ItemReference``. The reference uniquely identifies
